...
### Scoring (per round)
1. Add up the values of cards **by suit** (Hearts, Diamonds, Clubs, Spades).
2. Your **round score** is the **highest total from any one suit** in your hand.
...
- Final scores are shown in **descending order** (highest total wins).
...
### Replay
- After the game ends, players can optionally view a replay showing key actions/results from each round.
